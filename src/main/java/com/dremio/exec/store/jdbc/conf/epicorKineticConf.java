...
@SourceType(value = "epicorKineticARP", label = "epicorKinetic",uiConfig = "epicorkinetic-layout.json")
public class epicorKineticConf extends AbstractArpConf<epicorKineticConf> {
  private static final String ARP_FILENAME = "arp/implementation/epicorkinetic-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.epicorkinetic.epicorKineticDriver";
